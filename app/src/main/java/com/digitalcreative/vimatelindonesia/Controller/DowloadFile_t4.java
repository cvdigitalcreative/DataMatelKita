...
public class DowloadFile_t4 {
    ...
    private BroadcastReceiver onDownloadComplete_t4 = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            context.unregisterReceiver(onDownloadComplete_t4);
    ...
    public void startService_t0() {
        ...
        Intent serviceIntent = new Intent(context, ForegroundService_t4.class);
...
// get download service and enqueue file
    ...
    public void download(Context context){
        ...
        this.context.registerReceiver(onDownloadComplete_t4,new IntentFilter(DownloadManager.ACTION_DOWNLOAD_COMPLETE));
